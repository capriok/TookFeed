...
export default function Profile() {
   ...
   const dig = JSON.parse(localStorage.getItem('user'))
   const seed = dig.seed
   ...
   const EditUsernameButton = () => (
      !editUsernameOpen
         ?
         <div className="change" onClick={changeUsername}>Change Username</div>
         :
         <> <div className="change" onClick={toggleEditUsername}>Cancel</div>
            <div className="change left" onClick={confirmUsernameEdit}>Confirm</div></>
   )

   const confirmUsernameEdit = async () => {
      if (window.confirm('Are you sure you want to change your username?') === true) {
         axios
   ...
   const deleteAccount = () => {
      const pop = window.prompt('To delete your account, enter the username below. \n THIS CANNOT BE UNDONE')
      ...
      else { window.alert('Invalid confirmation') }
   }
   ...
   return (
      <div className="card">
         ...
         <div className="avatar">
            ...
            {!descInputOpen && <>
               <div className="descriptionbtn" onClick={editDesc}>Edit description</div>
               <li className="desc">{getDesc}</li>
            </>}
            {descInputOpen && <>
               <div className="descriptionbtn" onClick={toggleDescInput}>Cancel</div>
               <div className="descriptionbtn left" onClick={confirmDescEdit}>Confirm</div>
         ...
         <div className="overview">
            ...
            <li>Logged in since: {localStorage.getItem('lastLogin')}</li>
         </div>
         ...
         <div className="settings">
            ...
            <img src={peek ? passpeek : passhide} className="peek" onClick={togglePeek} alt=""></img>
            <li className="deletebtn" onClick={deleteAccount}>Delete Account</li>
         </div>
      </div>
   )
}